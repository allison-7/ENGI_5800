...
public class Variable extends ApiObject {
	...
	public double getMean(long startTime, long endTime) {
		return getStatistics(Value.StatisticsFigures.MEAN , startTime, endTime);
	}
	...
	public double getVariance(long startTime, long endTime) {
		return getStatistics(Value.StatisticsFigures.VARIANCE, startTime, endTime);
	}
	...
	public double getMin(long startTime, long endTime) {
		return getStatistics(Value.StatisticsFigures.MIN, startTime, endTime);
	}
	...
	public double getMax(long startTime, long endTime) {
		return getStatistics(Value.StatisticsFigures.MAX, startTime, endTime);
	}
	...
	public double getCount(long startTime, long endTime) {
		return getStatistics(Value.StatisticsFigures.COUNT, startTime, endTime);
	}
	...
	public double getSum(long startTime, long endTime) {
		return getStatistics(Value.StatisticsFigures.SUM, startTime, endTime);
	}
